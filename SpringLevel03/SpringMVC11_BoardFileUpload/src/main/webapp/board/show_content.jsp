...
<script type="text/javascript">
	...
	function deleteBoard() {
		...
		var d=confirm("삭제 하시겠습니까?");
			if(d)
				location.href="delete.do?no=${bvo.no}&&newfilename=${bvo.newfilename}"; //Controller에서 기능으로 연결..
		...
		<tr>
		   <td>
		   	    <table width="550">
					...
					<tr>
						<td>파일 :<a href="${pageContext.request.contextPath}
						/fileDown.do?orgfilename=${bvo.orgfilename}&&newfilename=${bvo.newfilename}">
						<b>${bvo.orgfilename}</b></a></td>
					</tr>
					</c:if>
					<tr>
						<td>
