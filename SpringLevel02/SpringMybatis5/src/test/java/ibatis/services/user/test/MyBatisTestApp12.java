 ...
 * FileName : MyBatisTestApp12.java
  * o MyBatis Framework 부분과 Spring DI 부분의 실질적인 연동.
...
public class MyBatisTestApp12 {
	...
	UserService userService = (UserService)context.getBean("userService12");
	...
	UserDAO userDAO = (UserDAO)context.getBean("userDAO12");
